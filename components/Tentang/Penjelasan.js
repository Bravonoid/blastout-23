      ...
      <h1 class="mobile:block drop-shadow-2xl shadow-yellow-500 text-white text-4xl font-bold pl-12 pt-12 pb-12 z-50 sm:hidden">TENTANG</h1>
        <div class="flex justify-center">
          <div class="flex lg:flex-row sm:gap-x-12 xl:mx-32 xl:px-8 mobile:mx-[62px] sm:mx-[62px] sm:px-5 bg-[#030022] py-5 w-fit rounded-[50px] mobile:flex-col z-50 sm:flex-col gap-y-5 max-w-[800px] 2xl:max-w-[1200px]">
            ...
            <Image src={Logo} alt="logo" class=" lg:w-[200px] lg:h-[200px] rounded-xl mobile:w-[88.43px] mobile:h-[88.43px] sm:w-[88.43px] sm:h-[88.43px] z-50 relative block mx-auto my-auto" />
            <div class="flex flex-col">
              {/* <h1 class="text-6xl font-bold font-TransAmerica">BLASTOUT</h1> */}
              <Image src={blastout} alt="blastout" class="w-1/2 mobile:hidden sm:w-[300px] sm:hidden lg:block pb-12"/>
              <p class="text-justify font-inter text-[#FFFFFF] mobile:px-5 z-50 mobile:pt-5 mobile:text-sm sm:text-sm">
              BlastOut merupakan program kerja tahunan dari Balairung Klass, organisasi mahasiswa daerah dengan anggota mahasiswa UGM yang berdomisili di Klaten. 
              Acara ini dilakukan secara offline selama 2 hari, yaitu Sabtu - Minggu, 4 - 5 Februari 2023. </p>
              <p class="text-justify font-inter text-[#FFFFFF] mobile:px-5 z-50 mobile:text-sm sm:text-sm">BlastOut terdiri dari rangkaian acara inti, yaitu:</p>
              <ol class="text-justify font-inter text-[#FFFFFF] mobile:px-5 z-50 mobile:text-sm sm:text-sm list-disc pl-5 mobile:pl-5">
                ...
                <li>faculty fair yang dihadiri oleh fakultas-fakultas dan beberapa UKM yang ada di UGM</li>
