    ...
    <>
      ...
      >
        <div class="flex flex-col justify-center items-center">
          ...
          <p
            className="bg-gradient-to-br from-[#8338ED] to-[#FF0070] px-3 py-2 rounded-full font-inter font-bold text-white text-sm lg:text-4xl lg:-mt-10 lg:px-6 lg:py-3 md:text-2xl"
            data-aos="fade-in"
            data-aos-delay={750}
          >
