...
const Sekilas1 = () => {
  ...
  return (
    <div className="bg-[#0F0B36] flex flex-col items-center justify-center text-white pt-20">
      <div className="flex flex-col items-center justify-center w-full" data-aos="fade-right">
        <div
      ...
      <div className="w-[60vw] font-inter text-[lg] sm:text-3xl text-center mt-[2.5vh] mb-[5vh] sm:my-[4vw]" data-aos="zoom-out-up" data-aos-delay={500}>
