...
const Penjelasan = () => {
  return (
    <>
      <div class="h-auto w-1/2 relative overflow-hidden py-20 pl-20 ">
        <div class="flex flex-col text-justify font-Inter">
          <div class="flex flex-row gap-x-6">
            <h1 class="font-bold text-6xl">
              TRYOUT <span class="bg-slate-300 p-2">DAY 1</span>
            </h1>
            <div class="border-black border-t-2 px-[80px] block my-auto" />
          </div>
          <p class="py-8">
